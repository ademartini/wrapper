...
f);a.addEventListener(google.ima.AdEvent.Type.IMPRESSION,f);a.addEventListener(google.ima.AdEvent.Type.CLICK,f);b.s()}function f(e){var c=e.getAd();if(c&&c.isLinear())switch(e.type){case google.ima.AdEvent.Type.LOADED:g=c;break;case google.ima.AdEvent.Type.STARTED:b.G();k=c.getDuration();b.c();p=setInterval(function(){a.getRemainingTime();if(null!==g){var c=g.getDuration();c!=k&&(k=c,b.c())}},300);break;case google.ima.AdEvent.Type.FIRST_QUARTILE:b.w();break;case google.ima.AdEvent.Type.MIDPOINT:b.B();
break;case google.ima.AdEvent.Type.THIRD_QUARTILE:b.H();break;case google.ima.AdEvent.Type.COMPLETE:clearInterval(p);b.v();break;case google.ima.AdEvent.Type.DURATION_CHANGE:b.c();break;case google.ima.AdEvent.Type.PAUSED:b.C();break;case google.ima.AdEvent.Type.RESUMED:b.D();break;case google.ima.AdEvent.Type.VOLUME_CHANGED:b.J();break;case google.ima.AdEvent.Type.VOLUME_MUTED:b.K();break;case google.ima.AdEvent.Type.SKIPPED:b.F();break;case google.ima.AdEvent.Type.USER_CLOSE:b.I();break;case google.ima.AdEvent.Type.IMPRESSION:b.A();
break;case google.ima.AdEvent.Type.CLICK:b.u()}}function m(c){try{a.destroy()}catch(n){}b.h(c.getError().getMessage())}function v(){}function e(){}var a,c,q,p,h,g,k=-2;return{m:function(){var a=document.getElementsByTagName("head")[0],b=document.createElement("script");b.setAttribute("type","text/javascript");b.setAttribute("src","https://imasdk.googleapis.com/js/sdkloader/ima3.js");a.appendChild(b);b.onload=u},M:function(){h.load();q.initialize();try{a.init(b.b,b.a,b.o),a.start()}catch(t){try{a.destroy()}catch(n){}b.h("Failed to start AdsManager")}},
L:function(){a.pause()},O:function(){a.resume()},g:function(){return a.getRemainingTime()},f:function(){return k},S:function(){a.stop()},P:function(b){a.setVolume(b)},l:function(){return a.getVolume()},N:function(b,c,e){a.resize(b,c,e)},getAdSkippableState:function(){return a.getAdSkippableState()},R:function(){a.skip()}}}
function A(){function b(b){try{var w=(new DOMParser).parseFromString(b,"text/xml").getElementsByTagName("CompanionAds");0<w.length&&(y=(new XMLSerializer).serializeToString(w[0]))}catch(B){}c=z({i:q,j:p,xml:b,bitrate:n,b:k,a:t,o:x,s:function(){a("AdLoaded")},G:function(){e("Started");a("AdVideoStart");a("AdStarted")},w:function(){a("AdVideoFirstQuartile")},B:function(){a("AdVideoMidpoint")},H:function(){a("AdVideoThirdQuartile")},v:function(){a("AdVideoComplete");u()},c:function(){a("AdDurationChange")},
C:function(){a("AdPaused")},D:function(){a("AdPlaying")},J:function(){a("AdVolumeChange")},K:function(){a("AdVolumeChange")},F:function(){a("AdSkipped")},I:function(){a("AdUserClose")},A:function(){a("AdImpression")},u:function(){a("AdClickThru")},h:function(){a("AdError")}});c.m()}function u(){e("Stopping ad");c.S();setTimeout(a,75,["AdStopped"])}function l(){e("getAdVolume");return c.l()}function f(){e("getAdSkippableState");return c.getAdSkippableState()}function m(){e("duration = "+c.f());return c.f()}
...
d.getAdHeight=function(){return t};d.getAdWidth=function(){return k};d.getAdSkippableState=f;d.getAdExpanded=function(){e("getAdExpanded");return!1};d.getAdVolume=l;d.setAdVolume=function(a){e("setAdVolume "+a);c.P(a)};d.unsubscribe=function(a){e("unsubscribe "+a);h[a]=null};d.subscribe=function(a,b,c){e("Subscribe for "+b+" - "+a);h[b]=a.bind(c)};d.expandAd=function(){e("expandAd (not supported)")};d.collapseAd=function(){e("collapseAd (not supported)")};d.skipAd=function(){e("skipAd");f()&&c.R()};
d.resumeAd=function(){e("resumeAd");c.O()};d.pauseAd=function(){e("pauseAd");c.L()};d.resizeAd=function(b,d,f){e("resizeAd "+b+"x"+d+" "+f);c.N(b,d,f);k=b;t=d;x=f;if(r){var w=l(),g=m();r.sendEvent("resizeAd",{volume:w,ad_duration:g,width:b,height:d,viewMode:f})}a("AdSizeChange")};d.initAd=function(c,d,f,h,m,l){k=c;t=d;n=h;x=f;q=l.i;p=l.j;g=JSON.parse(m.T);e("initAd "+c+"x"+d+" "+f+" "+h);null===p&&(p=document.createElement("video"),e("Warning: No video element passed to ad, creating element."),q.appendChild(p));
(c=g.U)&&"true"==c.toLowerCase()&&(c={anId:"924394",partner:"MediaMath",advId:g.advertiserId,campId:g.strategyId,pubId:g.exchangeId,placementId:g.creativeId,bidUrl:g.bidUrl,impId:g.auctionId},r=new __IASVANS,r.initCM(c));c=new XMLHttpRequest;c.timeout=2E3;c.onreadystatechange=function(){4==this.readyState&&(null!==this.responseText?b(this.responseText):a("AdError"))};c.ontimeout=function(){a("AdError")};c.open("GET",g.url,!0);c.send()};d.startAd=function(){e("Starting ad");c.M()};d.stopAd=u;d.handshakeVersion=
function(){return"2.0"};return d}window.getVPAIDAd=function(){return new A};
