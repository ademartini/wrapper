...
g);a.addEventListener(google.ima.AdEvent.Type.SKIPPED,g);a.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,g);a.addEventListener(google.ima.AdEvent.Type.IMPRESSION,g);a.addEventListener(google.ima.AdEvent.Type.CLICK,g);c.m()}function g(k){var b=k.getAd();if(b&&b.isLinear())switch(k.type){case google.ima.AdEvent.Type.LOADED:f=b;break;case google.ima.AdEvent.Type.STARTED:c.D();n=b.getDuration();c.c();d=setInterval(function(){a.getRemainingTime();if(null!==f){var d=f.getDuration();d!=n&&(n=d,c.c())}},
...
case google.ima.AdEvent.Type.SKIPPED:c.C();break;case google.ima.AdEvent.Type.USER_CLOSE:c.G();break;case google.ima.AdEvent.Type.IMPRESSION:c.v();break;case google.ima.AdEvent.Type.CLICK:c.o()}}function t(d){try{a.destroy()}catch(m){console.log("Error destroying AdsManager")}c.h(d.getError().getMessage())}function u(){}function p(){}var a,l,r,d,b,f,n=-2;this.j=function(){b=c.R;r=new google.ima.AdDisplayContainer(c.P,b);l=new google.ima.AdsLoader(r);l.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
...
function(){return n};this.destroy=function(){a.destroy()};this.N=function(d){a.setVolume(d)};this.i=function(){return a.getVolume()};this.L=function(d,c,b){a.resize(d,c,b)};this.getAdSkippableState=function(){return a.getAdSkippableState()};this.O=function(){a.skip()}}
function H(){function c(e,a){var c=document.getElementsByTagName("head")[0],b=document.createElement("script");b.setAttribute("type","text/javascript");b.setAttribute("src",e);b.onload=function(){d("loaded "+e);a()};c.appendChild(b)}function y(){var e=new XMLHttpRequest;e.timeout=2E3;e.onreadystatechange=function(){4==e.readyState&&(null!==e.responseText?t(e.responseText):b("AdError"))};e.ontimeout=function(){b("AdError")};e.open("GET",h.url,!0);e.send()}function g(e){var a="",d="";for(key in e)a+=
d,a+=encodeURIComponent(key)+"="+encodeURIComponent(e[key]),d="&";return a}function t(a){try{var e=(new DOMParser).parseFromString(a,"text/xml").getElementsByTagName("CompanionAds");0<e.length&&(console.log("got companion ads "+e),v=(new XMLSerializer).serializeToString(e[0]),console.log(v))}catch(J){}f=new G({P:n,R:k,xml:a,bitrate:C,b:w,a:x,l:z,m:function(){b("AdLoaded")},D:function(){d("Started");b("AdVideoStart");b("AdStarted")},u:function(){b("AdVideoFirstQuartile")},w:function(){b("AdVideoMidpoint")},
F:function(){b("AdVideoThirdQuartile")},s:function(){b("AdVideoComplete");u()},c:function(){b("AdDurationChange")},A:function(){b("AdPaused")},B:function(){b("AdPlaying")},H:function(){b("AdVolumeChange")},I:function(){b("AdVolumeChange")},C:function(){b("AdSkipped")},G:function(){b("AdUserClose")},v:function(){b("AdImpression")},o:function(){b("AdClickThru")},h:function(){b("AdError")}});f.j()}function u(){d("Stopping ad");try{f.destroy()}catch(e){}b("AdStopped")}function p(){d("getAdVolume");return f.i()}
function a(){d("getAdSkippableState");return f.getAdSkippableState()}function l(){d("duration = "+f.f());return f.f()}function r(){d("Only Linear Ads supported");return!0}function d(a){D&&console.log(a)}function b(a){d("raising event "+a);if(q){var e=p(),b=l();q.sendEvent(a,{volume:e,ad_duration:b})}E.push(a);if(e=m[a])for(key in e)if(b=e[key])d("found callback for "+a),(A||B)&&"AdStopped"==a&&b==F?function(a){setTimeout(function(){d("calling stop callback (after delay) "+a);a()},1E3)}(b):("AdStopped"==
a&&d("calling stop callback (no delay) "+b),b())}var f=null,n=null,k=null,m={},h={},w=-1,x=-1,C=-1,z=null,q=null,v=null,I=this,E=[],D=!1,B=!1,A=!1,F=null;this.getAdLinear=this.getAdLinear=r;this.getAdCompanions=function(){console.log("get companions "+v);return v};this.getAdIcons=function(){d("AdIcons not currently supported");return!1};this.getAdDuration=l;this.getAdRemainingTime=function(){d("remaining time = "+f.g());return f.g()};this.getAdHeight=function(){return x};this.getAdWidth=function(){return w};
this.getAdSkippableState=a;this.getAdExpanded=function(){d("getAdExpanded");return!1};this.getAdVolume=p;this.setAdVolume=function(a){d("setAdVolume "+a);f.N(a)};this.unsubscribe=function(a,b){d("unsubscribe "+b);m[b][a]=null};this.subscribe=function(a,b,c){d("Subscribe for "+b+" - "+a);c=c?a.bind(c):a;var e=m[b];e||("AdStopped"==b&&(F=c),e=m[b]={});e[a]=c};this.expandAd=function(){d("expandAd (not supported)")};this.collapseAd=function(){d("collapseAd (not supported)")};this.skipAd=function(){d("skipAd");
a()&&f.O()};this.resumeAd=function(){d("resumeAd");f.M()};this.pauseAd=function(){d("pauseAd");f.J()};this.resizeAd=function(a,c,g){d("resizeAd "+a+"x"+c+" "+g);f.L(a,c,g);w=a;x=c;z=g;if(q){var e=p(),h=l();q.sendEvent("resizeAd",{volume:e,ad_duration:h,width:a,height:c,viewMode:g})}b("AdSizeChange")};this.initAd=function(a,b,f,l,m,p){w=a;x=b;C=l;z=f;n=p.slot;k=p.videoSlot;h=JSON.parse(m.AdParameters);D=(m=h.debug)&&"true"==m.toLowerCase();d("initAd "+a+"x"+b+" "+f+" "+l);null===k&&(k=document.createElement("video"),
d("Warning: No video element passed to ad, creating element."),n.appendChild(k));(B=h.dvEnabled)&&"true"==B.toLowerCase()&&(f="dv_callback"+((new Date).getTime()+""+Math.floor(1E7*Math.random())).substr(0,16),window[f]=function(){return I},c("https://cdn.doubleverify.com/dvvid_src.js?"+g({ctx:"499507",cmp:"DV016560",sid:"17306",plc:"201612132",advid:"3065265",adsrv:"27",tagformat:"2",tagtype:"video",dvtagver:"6.1.src",DVP_ADV:h.advertiserId,DVPX_BIDID:h.auctionId,DVP_MM_3:h.strategyId,DVP_MM_4:h.creativeId,
DVP_MM_5:h.exchangeId,DVP_GVACB:f})));(A=h.iasEnabled)&&"true"==A.toLowerCase()&&(a={anId:"924937",partner:"MediaMath",advId:h.campaignId,campId:h.strategyId,pubId:h.exchangeId,chanId:a+"x"+b,placementId:h.creativeId,planId:h.siteId,adsafe_par:"",bundleId:"",uId:h.advertiserId,bidUrl:h.bidUrl,impId:h.auctionId},q=new __IASVANS,q.initCM(a,n));d("loading IMA https://imasdk.googleapis.com/js/sdkloader/ima3.js");c("https://imasdk.googleapis.com/js/sdkloader/ima3.js",y)};this.startAd=function(){d("Starting ad");
f.K()};this.stopAd=u;this.handshakeVersion=function(){return"2.0"};this.getPlayer=function(){return k};this.getSlot=function(){return n};this.getPreviousEvents=function(){return E}}window.getVPAIDAd=function(){return new H};
