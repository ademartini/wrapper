...
b[key];e&&(c("found callback for "+f),(y||z)&&"AdStopped"==f?setTimeout(function(){e()},1E3):e())}}var g=null,n=null,k=null,p={},d={},u=-1,v=-1,B=-1,x=null,r=null,A=null,G=this,D=[],C=!1,z=!1,y=!1;b("http://imasdk.googleapis.com/js/sdkloader/ima3.js");this.getAdLinear=this.getAdLinear=l;this.getAdCompanions=function(){return A};this.getAdIcons=function(){c("AdIcons not currently supported");return!1};this.getAdDuration=a;this.getAdRemainingTime=function(){c("remaining time = "+g.g());return g.g()};
