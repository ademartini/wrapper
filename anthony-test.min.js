...
{volume:b,ad_duration:d})}D.push(f);var e=p[f];if(e)for(key in e)"AdStopped"==f&&console.log("Stopped Key: "+key),e[key]&&(c("found callback for "+f),(y||z)&&"AdStopped"==f&&e[key]==E?setTimeout(function(){console.log("called stop callback (with delay) "+key);e[key]()},1E3):("AdStopped"==f&&console.log("called stop callback (no delay) "+key),e[key]()))}var g=null,n=null,k=null,p={},d={},u=-1,v=-1,B=-1,x=null,r=null,A=null,H=this,D=[],C=!1,z=!1,y=!1,E=null;b("https://imasdk.googleapis.com/js/sdkloader/ima3.js");
