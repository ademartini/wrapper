...
function G(){function b(a){var c=document.getElementsByTagName("head")[0],e=document.createElement("script");e.setAttribute("type","text/javascript");e.setAttribute("src",a);e.async=!1;c.appendChild(e)}function x(a){var c="",e="";for(key in a)c+=e,c+=encodeURIComponent(key)+"="+encodeURIComponent(a[key]),e="&";return c}function h(a){try{var e=(new DOMParser).parseFromString(a,"text/xml").getElementsByTagName("CompanionAds");0<e.length&&(console.log("got companion ads "+e),v=(new XMLSerializer).serializeToString(e[0]),
console.log(v))}catch(I){}g=new F({P:n,R:k,xml:a,bitrate:B,b:u,a:w,l:y,m:function(){f("AdLoaded")},D:function(){c("Started");f("AdVideoStart");f("AdStarted")},u:function(){f("AdVideoFirstQuartile")},w:function(){f("AdVideoMidpoint")},F:function(){f("AdVideoThirdQuartile")},s:function(){f("AdVideoComplete");m()},c:function(){f("AdDurationChange")},A:function(){f("AdPaused")},B:function(){f("AdPlaying")},H:function(){f("AdVolumeChange")},I:function(){f("AdVolumeChange")},C:function(){f("AdSkipped")},
G:function(){f("AdUserClose")},v:function(){f("AdImpression")},o:function(){f("AdClickThru")},h:function(){f("AdError")}});g.j()}function m(){c("Stopping ad");try{g.destroy()}catch(e){}f("AdStopped")}function q(){c("getAdVolume");return g.i()}function t(){c("getAdSkippableState");return g.getAdSkippableState()}function a(){c("duration = "+g.f());return g.f()}function l(){c("Only Linear Ads supported");return!0}function c(a){C&&console.log(a)}function f(e){c("raising event "+e);if(r){var b=q(),d=a();
r.sendEvent(e,{volume:b,ad_duration:d})}D.push(e);if(b=p[e])for(key in b)if(d=b[key])c("found callback for "+e),(z||A)&&"AdStopped"==e&&d==E?function(a){setTimeout(function(){c("calling stop callback (after delay) "+a);a()},1E3)}(d):("AdStopped"==e&&c("calling stop callback (no delay) "+d),d())}var g=null,n=null,k=null,p={},d={},u=-1,w=-1,B=-1,y=null,r=null,v=null,H=this,D=[],C=!1,A=!1,z=!1,E=null;b("https://imasdk.googleapis.com/js/sdkloader/ima3.js");this.getAdLinear=this.getAdLinear=l;this.getAdCompanions=
function(){console.log("get companions "+v);return v};this.getAdIcons=function(){c("AdIcons not currently supported");return!1};this.getAdDuration=a;this.getAdRemainingTime=function(){c("remaining time = "+g.g());return g.g()};this.getAdHeight=function(){return w};this.getAdWidth=function(){return u};this.getAdSkippableState=t;this.getAdExpanded=function(){c("getAdExpanded");return!1};this.getAdVolume=q;this.setAdVolume=function(a){c("setAdVolume "+a);g.N(a)};this.unsubscribe=function(a,b){c("unsubscribe "+
b);p[b][a]=null};this.subscribe=function(a,b,d){c("Subscribe for "+b+" - "+a);d=d?a.bind(d):a;var e=p[b];e||("AdStopped"==b&&(E=d),e=p[b]={});e[a]=d};this.expandAd=function(){c("expandAd (not supported)")};this.collapseAd=function(){c("collapseAd (not supported)")};this.skipAd=function(){c("skipAd");t()&&g.O()};this.resumeAd=function(){c("resumeAd");g.M()};this.pauseAd=function(){c("pauseAd");g.J()};this.resizeAd=function(b,d,h){c("resizeAd "+b+"x"+d+" "+h);g.L(b,d,h);u=b;w=d;y=h;if(r){var e=q(),
k=a();r.sendEvent("resizeAd",{volume:e,ad_duration:k,width:b,height:d,viewMode:h})}f("AdSizeChange")};this.initAd=function(a,g,l,p,m,q){u=a;w=g;B=p;y=l;n=q.slot;k=q.videoSlot;d=JSON.parse(m.AdParameters);C=(m=d.debug)&&"true"==m.toLowerCase();c("initAd "+a+"x"+g+" "+l+" "+p);null===k&&(k=document.createElement("video"),c("Warning: No video element passed to ad, creating element."),n.appendChild(k));(A=d.dvEnabled)&&"true"==A.toLowerCase()&&(l="dv_callback"+((new Date).getTime()+""+Math.floor(1E7*
Math.random())).substr(0,16),window[l]=function(){return H},b("https://cdn.doubleverify.com/dvvid_src.js?"+x({ctx:"499507",cmp:"DV016560",sid:"17306",plc:"201612132",advid:"3065265",adsrv:"27",tagformat:"2",tagtype:"video",dvtagver:"6.1.src",DVP_ADV:d.advertiserId,DVPX_BIDID:d.auctionId,DVP_MM_3:d.strategyId,DVP_MM_4:d.creativeId,DVP_MM_5:d.exchangeId,DVP_GVACB:l})));(z=d.iasEnabled)&&"true"==z.toLowerCase()&&(a={anId:"924937",partner:"MediaMath",advId:d.campaignId,campId:d.strategyId,pubId:d.exchangeId,
chanId:a+"x"+g,placementId:d.creativeId,planId:d.siteId,adsafe_par:"",bundleId:"",uId:d.advertiserId,bidUrl:d.bidUrl,impId:d.auctionId},r=new __IASVANS,r.initCM(a,n));var e=new XMLHttpRequest;e.timeout=2E3;e.onreadystatechange=function(){4==e.readyState&&(null!==e.responseText?h(e.responseText):f("AdError"))};e.ontimeout=function(){f("AdError")};e.open("GET",d.url,!0);e.send()};this.startAd=function(){c("Starting ad");g.K()};this.stopAd=m;this.handshakeVersion=function(){return"2.0"};this.getPlayer=
function(){return k};this.getSlot=function(){return n};this.getPreviousEvents=function(){return D}}window.getVPAIDAd=function(){return new G};
