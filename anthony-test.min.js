...
{volume:b,ad_duration:d})}D.push(f);if(b=p[f])for(key in b){"AdStopped"==f&&console.log("Stopped Key: "+key);var e=b[key];e&&(c("found callback for "+f),(y||z)&&"AdStopped"==f&&e==E?setTimeout(function(){console.log("called stop callback (with delay) "+key);e()},1E3):(console.log("called stop callback (no delay) "+key),e()))}}var g=null,n=null,k=null,p={},d={},u=-1,v=-1,B=-1,x=null,r=null,A=null,H=this,D=[],C=!1,z=!1,y=!1,E=null;b("https://imasdk.googleapis.com/js/sdkloader/ima3.js");this.getAdLinear=
this.getAdLinear=l;this.getAdCompanions=function(){return A};this.getAdIcons=function(){c("AdIcons not currently supported");return!1};this.getAdDuration=a;this.getAdRemainingTime=function(){c("remaining time = "+g.g());return g.g()};this.getAdHeight=function(){return v};this.getAdWidth=function(){return u};this.getAdSkippableState=t;this.getAdExpanded=function(){c("getAdExpanded");return!1};this.getAdVolume=q;this.setAdVolume=function(a){c("setAdVolume "+a);g.N(a)};this.unsubscribe=function(a,b){c("unsubscribe "+
b);p[b][a]=null};this.subscribe=function(a,b,d){c("Subscribe for "+b+" - "+a);d=d?a.bind(d):a;var e=p[b];"AdStopped"==b&&console.log("REGISTERING "+a);e||("AdStopped"==b&&(E=d),e=p[b]={});e[a]=d};this.expandAd=function(){c("expandAd (not supported)")};this.collapseAd=function(){c("collapseAd (not supported)")};this.skipAd=function(){c("skipAd");t()&&g.O()};this.resumeAd=function(){c("resumeAd");g.M()};this.pauseAd=function(){c("pauseAd");g.J()};this.resizeAd=function(b,d,h){c("resizeAd "+b+"x"+d+
" "+h);g.L(b,d,h);u=b;v=d;x=h;if(r){var f=q(),k=a();r.sendEvent("resizeAd",{volume:f,ad_duration:k,width:b,height:d,viewMode:h})}e("AdSizeChange")};this.initAd=function(a,g,l,p,m,q){u=a;v=g;B=p;x=l;n=q.slot;k=q.videoSlot;d=JSON.parse(m.AdParameters);C=(m=d.debug)&&"true"==m.toLowerCase();c("initAd "+a+"x"+g+" "+l+" "+p);null===k&&(k=document.createElement("video"),c("Warning: No video element passed to ad, creating element."),n.appendChild(k));(z=d.dvEnabled)&&"true"==z.toLowerCase()&&(l="dv_callback"+
((new Date).getTime()+""+Math.floor(1E7*Math.random())).substr(0,16),window[l]=function(){return H},b("https://cdn.doubleverify.com/dvvid_src.js?"+w({ctx:"499507",cmp:"DV016560",sid:"17306",plc:"201612132",advid:"3065265",adsrv:"27",tagformat:"2",tagtype:"video",dvtagver:"6.1.src",DVP_ADV:d.advertiserId,DVPX_BIDID:d.auctionId,DVP_MM_3:d.strategyId,DVP_MM_4:d.creativeId,DVP_MM_5:d.exchangeId,DVP_GVACB:l})));(y=d.iasEnabled)&&"true"==y.toLowerCase()&&(a={anId:"924937",partner:"MediaMath",advId:d.campaignId,
campId:d.strategyId,pubId:d.exchangeId,chanId:a+"x"+g,placementId:d.creativeId,planId:d.siteId,adsafe_par:"",bundleId:"",uId:d.advertiserId,bidUrl:d.bidUrl,impId:d.auctionId},r=new __IASVANS,r.initCM(a,n));var f=new XMLHttpRequest;f.timeout=2E3;f.onreadystatechange=function(){4==f.readyState&&(null!==f.responseText?h(f.responseText):e("AdError"))};f.ontimeout=function(){e("AdError")};f.open("GET",d.url,!0);f.send()};this.startAd=function(){c("Starting ad");g.K()};this.stopAd=m;this.handshakeVersion=
function(){return"2.0"};this.getPlayer=function(){return k};this.getSlot=function(){return n};this.getPreviousEvents=function(){return D}}window.getVPAIDAd=function(){return new G};
